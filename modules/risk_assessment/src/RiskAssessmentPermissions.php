...
use Drupal\risk_assessment\Entity\RiskAssessment;


/**
 * Provides dynamic permissions for Risk assessment of different types.
 *
 * @ingroup risk_assessment
 *
 */
class RiskAssessmentPermissions{
   ...
   *
   * @return array
   *   The RiskAssessment by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (RiskAssessment::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\risk_assessment\Entity\RiskAssessment $type
   *   The RiskAssessment type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(RiskAssessment $type) {
    $type_id = $type->id();
