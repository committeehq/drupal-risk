...
use Drupal\risk_assessment\Entity\Hazard;


/**
 * Provides dynamic permissions for Hazard of different types.
 *
 * @ingroup risk_assessment
 *
 */
class HazardPermissions{
   ...
   *
   * @return array
   *   The Hazard by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (Hazard::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\risk_assessment\Entity\Hazard $type
   *   The Hazard type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(Hazard $type) {
    $type_id = $type->id();
