...
use Drupal\risk_assessment\Entity\Activity;


/**
 * Provides dynamic permissions for Activity of different types.
 *
...
class ActivityPermissions{
   ...
   *
   * @return array
   *   The Activity by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (Activity::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\risk_assessment\Entity\Activity $type
   *   The Activity type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(Activity $type) {
    $type_id = $type->id();
